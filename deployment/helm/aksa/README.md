...
| --------------------------------------------- | ------------------------------------------------------------------------------------------- | -------------------------------------------- |
| `frontend.image.repository`                   | The aksa image to deploy                                                                 | `registry.aksa.local/aksa/aksa-frontend` |
...
| `frontend.image.args`                         | Aguments for the aksa backend                                                            | `[]`                                         |
...
| Name                                         | Description                                                                                 | Value                                     |
| -------------------------------------------- | ------------------------------------------------------------------------------------------- | ----------------------------------------- |
| `backend.image.repository`                   | The aksa image to deploy                                                                 | `registry.aksa.local/aksa/aksa-server` |
...
| `backend.image.args`                         | Aguments for the aksa backend                                                            | `["-disable-check-origin"]`    |
...
| `ingress.hostname`         | Default host for the ingress record. Set “*” here to omit the host.                                                              | `aksa.local` |
